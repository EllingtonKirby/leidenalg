...
class ContiguousConstrainedVertexPartition(MutableVertexPartition):
  
  def __init__(self, graph, node_attributes, resolution_parameter, initial_membership=None, weights=None):
    """
    Parameters
    ----------
    graph : :class:`ig.Graph`
    ...
    self._partition = _c_leiden._new_ContiguousConstrainedVertexPartition(pygraph_t,
      node_attributes, resolution_parameter, initial_membership, weights)
    self._update_internal_membership()
